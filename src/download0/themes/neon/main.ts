...
(function () {
  ...
  // ── Background ────────────────────────────────────────────────────────────────
  // Dedicated dark cyberpunk background (dark navy + cyan grid)
  const bg = new Image({
  ...
  const rightPanel = new Image({
    url: buttonImg, x: 1340, y: 0,
    width: 580, height: 1080, alpha: 0.18
  })
  jsmaf.root.children.push(rightPanel)

  const panelBorder = new Image({
    url: buttonImg, x: 1338, y: 0,
    width: 2, height: 1080, alpha: 0.55
  })
  ...
  const sep1 = new Image({
    url: buttonImg, x: panelLeft, y: 344,
    width: buttonWidth, height: 2, alpha: 0.9
  })
  ...
  const sep2 = new Image({
    url: buttonImg, x: panelLeft + 60, y: 350,
    width: buttonWidth - 120, height: 1, alpha: 0.4
  })
  ...
  const leftBar = new Image({
    url: buttonImg,
    x: panelLeft - 18, y: startY - 8,
    width: 3, height: 4 * spacing + 16, alpha: 0.55
  })
  ...
  for (let i = 0; i < menuOptions.length; i++) {
    ...
    const glow = new Image({
      url: buttonImg,
      x: btnX - 8, y: btnY - 8,
      width: buttonWidth + 16, height: buttonHeight + 16,
    ...
    const button = new Image({
      url: buttonImg,
      x: btnX, y: btnY,
      width: buttonWidth, height: buttonHeight, alpha: 0.30
    })
    buttons.push(button)
    ...
    if (useImageText) {
      btnText = new Image({
        ...
        x: btnX + 24, y: btnY + 13, width: 300, height: 50
      })
    } else {
  ...
  const exitGlow = new Image({
    url: buttonImg, x: exitX - 8, y: exitY - 8,
    width: buttonWidth + 16, height: buttonHeight + 16,
    alpha: 0, visible: false
  })
  ...
  const exitButton = new Image({
    url: buttonImg, x: exitX, y: exitY,
    width: buttonWidth, height: buttonHeight, alpha: 0.20
  })
  ...
  if (useImageText) {
    exitText = new Image({
      ...
      x: exitX + 24, y: exitY + 13, width: 300, height: 50
    })
  } else {
  ...
  const footerBg = new Image({
    url: buttonImg, x: 0, y: 1038,
    width: 1920, height: 42, alpha: 0.40
  })
  jsmaf.root.children.push(footerBg)

  const footerLine = new Image({
    url: buttonImg, x: 0, y: 1037,
    width: 1920, height: 1, alpha: 0.6
  })
