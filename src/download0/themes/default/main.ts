...
;(function () {
  ...
  const gl = new Image({ url: CYAN, x: -100, y: -100, width: 900, height: 600 })
  ...
  for (let i = 0; i < items.length; i++) {
    ...
    btn.alpha = 0.06; btn.borderColor = 'rgba(60,200,230,0.16)'; btn.borderWidth = 1
